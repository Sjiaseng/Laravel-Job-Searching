    ...
    <x-card class="p-10">
        ...
        <div>
            ...
            <div class="text-lg space-y-6">
                ...
                <a href="mailto:{{$listing -> email}}" class="block bg-laravel text-white mt-6 py-3 rounded-xl hover:opacity-80">
                    <i class="fa-solid fa-envelope"  style="margin-right: 8px;"></i>
                    Contact Employer 
                </a>

                <a href="{{$listing -> website}}" target ="_blank" class="block bg-black text-white py-3 rounded-xl hover:opacity-80">
